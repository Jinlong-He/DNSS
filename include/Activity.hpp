...
namespace atm {
    ...
    typedef unordered_map<Activity*, ID> Act2IDMap;
    typedef unordered_map<Activity*, Acts> Act2ActsMap;
    typedef unordered_map<Aft, Acts> Aft2ActsMap;
    typedef unordered_map<Activity*, vector<Act2IDMap> > Act2ActsVecMap;
    ...
    public:
       ...
       /// \brief Gets the available positions for this Activity.
        ...
        bool addAvailablePos(Activity* act, ID pos, ID& maxLength, const Act2IDMap& visited, ContentMap& contentMap);
